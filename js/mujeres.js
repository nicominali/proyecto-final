...
const addToShoppingCartButtons = document.querySelectorAll('.botonCompra')
...
const shoppingCartItemsContainer = document.getElementsByClassName('.shoppingCartItemsContainer');
...
function updateShoppingCartTotal(){
    ...
    shoppingCartItems.forEach((shoppingCartItem) =>{
        const shoppingCartContentItemPriceElement = shoppingCartItem.querySelectorAll('.shoppingCartItemPrice');
        
        const shoppingCartItemPrice = Number (shoppingCartContentItemPriceElement.textContent.replace('$',''));
...
function addItemToShoppingCart(itemTitle, itemPrice, itemImage) {
  ...
  <div class="row shoppingCartItem">
        <div class="col-6">
            <div class="shopping-cart-item d-flex align-items-center h-100 border-bottom pb-2 pt-3">
                <img src=${itemImage} class="shopping-cart-image" width="350px" height="350px">
                <h6 class="shopping-cart-item-title shoppingCartItemTitle text-truncate ml-3 mb-0">${itemTitle}</h6>
            </div>
        </div>
        <div class="col-2">
